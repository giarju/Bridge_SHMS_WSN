...
public class Wavelet {
    ...
    public static double[] getLowPass(int wavelet_code, int wavelet_order) {
    ...
    public static float[] getHighPass(float[] lowpass){
        int sign = 1;
	...
	public static float roundNearestDecimal(double data, int decimal_point){
		return (float)(Math.round(data*Math.pow(10,decimal_point))/Math.pow(10,decimal_point)); 
	}

	public static float[] roundArray2Float(double[] data, int decimal_point){
	...
	public static void removeMean(float[] array){
    ...
    public static float[] circConvDsmp2(float[] signal, float[] kernel, int signal_len){
	...
	public static float[] circConvDsmp2(float[] signal, float[] kernel, int signal_len, int start_index){
        float[] result = new float[signal_len/2];
        int kernel_len = kernel.length;
        int index = 0;
	...
	public static float[] circCorrUpsmp2(float[] signal, float[] kernel, int signal_len, int start_index){
		float[] result = new float[signal_len*2];
    ...
    public static float[] forwardDWT(float[] signal, int level, int wavelet_code, int wavelet_order){
        int n = signal.length;
	...
	public static float[] inverseDWT(float[] signal, int level, int wavelet_code, int wavelet_order){
        int n = signal.length;
        float[] H = roundArray2Float(getLowPass(wavelet_code, wavelet_order),6);
		float[] G = getHighPass(H);
	...
	public static float[] forwardWPT(float[] signal, int level, int wavelet_code, int wavelet_order){
        int n = signal.length;
        float[] H = roundArray2Float(getLowPass(wavelet_code, wavelet_order),6);
		float[] G = getHighPass(H);
        for (int i = 0; i < level; i++) 
	...
	public static float[] inverseWPT(float[] signal, int level, int wavelet_code, int wavelet_order){
        int n = signal.length;
		float[] H = roundArray2Float(getLowPass(wavelet_code, wavelet_order),6);
		float[] G = getHighPass(H);
        for (int i = level; i > 0; i--) 
	...
	public static float[] calcEnergyDWT(float[] dwt, int level){
		int n = dwt.length;
	...
	public static float[] calcEnergyWPT(float[] wpt, int level){
		int n =wpt.length;
	...
	public static void bubbleSort(float[] mag, float[] freq){
	    float ctemp_mag;
	    float ctemp_freq;
	...
	public static void retainedEnergyComponent(float[] wt_energy, float[] retained, float[] retained_index){
	...
	public static float calcSSD(float[] wpt_energy_base, float[] wpt_energy_measured, int dominant_num){
		float SSD = 0;
	...
	public static float calcSAD(float[] wpt_energy_base, float[] wpt_energy_measured, int dominant_num){
		float SAD = 0;
	...
	public static float calcUCL(float[] indicator_array){
	...
	public static void dominantPeak(float[] array, int window_length, int peak_num, float[] peak, int[] index){
